    ...
    <>
      <div className="p-4 border-b border-gray-200 flex items-center">
        ...
        <div
          ...
          } bg-gray-100 rounded-md p-1 cursor-pointer`}
      ...
      {!collapsed && (
        <div className="p-3 border-b border-gray-200">
          <div className="flex items-center gap-2 bg-purple-100 text-purple-800 rounded-md p-2">
      ...
      <div className="flex-1 overflow-auto">
        <div className={`${collapsed ? "p-1" : "p-2"}`}>
          ...
          <Link
            ...
            } ${isActive("/auto-blog") ? "text-blue-600" : "text-gray-600"}`}
          >
          ...
          <Link
            ...
            className={`flex items-center ${
              ...
              isActive("/internal-links") ? "text-blue-600" : "text-gray-600"
            }`}
          >
          ...
          <Link
            ...
            className={`flex items-center ${
              ...
              isActive("/free-backlinks") ? "text-blue-600" : "text-gray-600"
            }`}
          >
          ...
          <Link
            ...
            className={`flex items-center ${
              collapsed ? "justify-center p-1 my-4" : "gap-2 p-2"
            } ${isActive("/integration") ? "text-blue-600" : "text-gray-600"}`}
          >
          ...
          <Link
            ...
            className={`flex items-center ${
              ...
              isActive("/affiliate-program") ? "text-blue-600" : "text-gray-600"
            }`}
          >
          ...
          <Link
            ...
            className={`flex items-center ${
              collapsed ? "justify-center p-1 my-4" : "gap-2 p-2"
            } ${isActive("/team-center") ? "text-blue-600" : "text-gray-600"}`}
          >
            <Users className="h-4 w-4" />
          ...
          <Link
            ...
            className={`flex items-center ${
              collapsed ? "justify-center p-1 my-4" : "gap-2 p-2"
            } ${isActive("/updates") ? "text-blue-600" : "text-gray-600"}`}
          >
          ...
          <Link
            ...
            className={`flex items-center ${
              collapsed ? "justify-center p-1 my-4" : "gap-2 p-2"
            } ${isActive("/live-chat") ? "text-blue-600" : "text-gray-600"}`}
          >
